<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Identity Card -->
        <div class="mt-4">
            <x-input-label for="identity_card" :value="__('Cédula de Identidad')" />
            <x-text-input id="identity_card" class="block mt-1 w-full" type="text" name="identity_card" :value="old('identity_card')" required autocomplete="off" />
