<x-app-layout>
    <h1 class="text-center font-semibold text-2xl my-8">Editar Habitación</h1>

    <div class="max-w-lg mx-auto my-8">
        <form action="{{ route('admin.rooms.update', $room->id) }}" method="post" autocomplete="off">
            @csrf
            @method('put')

            <x-input-error :messages="$errors->get('name')" class="mt-2" />
            <div class="mb-4">
                <label for="name" class="block font-medium text-sm text-gray-700 mb-2">Paquete</label>
                <input 
                    id="name"
                    name="name"
                    type="text"
            ...
            <div class="mb-4">
                <label for="price" class="block font-medium text-sm text-gray-700 mb-2">Precio en Bs.-</label>
                <input 
                    id="price"
                    name="price"
                    type="number"
            ...
            <div class="mb-4">
                <label for="number" class="block font-medium text-sm text-gray-700 mb-2">Número de habitación</label>
                <input 
                    id="number"
                    name="number"
                    type="text"
            ...
            <div class="mb-4">
                ...
                <select name="status" id="status" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <option value="limpieza" {{ old('status', $room->status) === 'limpieza' ? 'selected' : '' }}>Limpieza</option>
            ...
            <div class="mb-4">
                ...
                <input 
                    ...
                    name="ubication"
                    type="text"
                    value="{{ old('ubication', $room->ubication) }}"
                    class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div class="mb-4">
                <label for="category_id" class="block font-medium text-sm text-gray-700 mb-2">Tipo de Habitación</label>
